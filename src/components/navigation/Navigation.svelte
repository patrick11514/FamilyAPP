...
<ClickOutside
    ...
    class={twMerge(
        'bg-secondary absolute top-0 left-0 z-50 flex min-h-screen w-1/2 min-w-96 flex-col p-2 transition-transform duration-500 md:static md:w-auto md:translate-x-0',
